  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: const [NotificacionCampana(esAdmin: true), SizedBox(width: 4)],
        bottom: TabBar(
      ...
      builder: (context, snapshot) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, i) {
            ...
            final usuario =
                data['usuarioEmail'] ?? data['usuarioId'] ?? 'Usuario';
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: _procesando
                          ? null
                          : () => _mostrarDialogoRechazo(context),
                      icon: const Icon(
                        Icons.close_rounded,
                        color: Colors.white,
                      ),
    ...
    try {
      ...
      if (pasos.isNotEmpty) {
        await FirebaseFirestore.instance
            ...
            .doc(nuevaRef.id)
            .set({'pasos_ordenados': pasos, 'receta_id': nuevaRef.id});
      }
      await FirebaseFirestore.instance
          .collection('recetas-pendientes')
          .doc(widget.docId)
      ...
      if (origenId != null && origenId.isNotEmpty) {
        await FirebaseFirestore.instance
            ...
            .doc(origenId)
            .update({'estado': 'publicada', 'estadoRevision': 'aprobada'});
      }
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (motivo.isEmpty) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Escribe un motivo'),

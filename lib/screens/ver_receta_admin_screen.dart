                        ...
                        children: [
                          ...
                          if (ings.isEmpty)
                            ...
                            ListView.separated(
                              ...
                              itemBuilder: (_, i) =>
                                  _IngRow(ing: ings[i], calcNum: _calcularNumero, abrevU: _abreviarUnidad),
                            ),
                        ],
                      ),
                    ),
...
class _IngRow extends StatelessWidget {
  ...
  const _IngRow(
      {required this.ing, required this.calcNum, required this.abrevU});
  ...
  Widget build(BuildContext context) {
    ...
    final String unidadAbrev =
        ing.unidad.trim().isNotEmpty ? abrevU(ing.unidad.trim(), ing.cantidad) : '';
    final String cantidadTexto =
        unidadAbrev.isNotEmpty ? '$numero $unidadAbrev' : numero;
